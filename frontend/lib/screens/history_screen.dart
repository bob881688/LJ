    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            Text("學習紀錄", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.white)),
      ...
      body: isLoading
          ...
          : sessions.isEmpty
          ? const Center(child: Text("目前沒有還練習紀錄，快去測驗吧！", style: TextStyle(color: Colors.white)))
          : Column(
        children: [
          // 模式選擇
          Container(
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected ? Colors.white24 : Colors.transparent, // 選中時半透明底
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (ctx, index) {
                ...
                List<String> options = [];
                if (detail['options'] != null && detail['options'] != "") {
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ...options.map((optText) {
                        // 判斷這一題是使用者選的還是正確答案
                        bool isUserSelected = optText == detail['user_answer'];
                        bool isCorrect = optText == detail['correct_answer'];
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: isUserSelected ? Colors.white10 : Colors.transparent,
                          ),
                          child: Row(
